...
export default function Navbar() {
    ...
    return (
        <header className="flex flex-row py-1 border-b border-everglade lg:px-8 mx-4 lg:mx-0 space-x-3 bg-mikado">
            <div className="flex items-center space-x-4">
                ...
                <div className="relative group">
                    ...
                    <div className="invisible absolute z-50 flex flex-col group-hover:visible group-hover:opacity-100 bg-mikado rounded-lg shadow-lg opacity-0 transition-opacity duration-200 w-max">
                        <Link href="/team/coreTeam" className="my-2 block py-1 px-4 hover:bg-gray-100">
                            Core Team
                        </Link>
                        <Link href="/team/coapplicants" className="my-2 block py-1 px-4 hover:bg-gray-100">
                            Core Faculty Team
                        </Link>
                        <Link href="/team/collaborators" className="my-2 block py-1 px-4 hover:bg-gray-100">
                            Collaborators
                        </Link>
                    </div>
                </div>
